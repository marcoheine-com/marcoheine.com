    ...
    <Layout>
      ...
      <ui.PageContent>
        ...
        <ul>
          ...
          <li>
            <p>
              I use a Dell 4K 32&quot; monitor as my main{' '}
              <strong>monitor</strong>. Currently I have the MacBook right in
              front of it and use the keyboard of it.
            </p>
          </li>
          <li>
            <p>
              I&apos;m thinking about getting a mechanical keyboard and a mouse
              so I can set the MacBook to the right side of my monitor.
            </p>
            <li>
