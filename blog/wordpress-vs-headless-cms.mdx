...
[Next.js](https://nextjs.org/) or [Remix](remix.run/), or a simple, plain, and
static HTML site. You are not bound to the server-side-rendering technique with
PHP, which WordPress uses.
