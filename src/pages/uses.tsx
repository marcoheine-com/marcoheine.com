      ...
      <section className="mx-auto mb-0 mt-20">
        <section className="mb-12">
          <p>
            ...
            initiated by{' '}
            <CustomLink href="https://twitter.com/wesbos">Wes Bos</CustomLink>,
            I decided to partizipate and share my own <i>uses</i> collection.
          </p>
          ...
          <ul>
            <li>
              <p>
                ...
                use <CustomLink href="https://netlify.com">Netlify</CustomLink>{' '}
                and <CustomLink href="https://vercel.com">Vercel</CustomLink>.
                They are both amazing services that takes away so much
                configuration and just help me ship my code as fast as possible.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                <CustomLink href="/today-i-learned">
                  {' '}
                  today-i-learned
                </CustomLink>{' '}
                post writings I use{' '}
                <CustomLink href="https://notion.so">Notion</CustomLink>. We
                also use it heavily for client projects. Kanban Boards,
                requirement collections, meeting notes it all goes in there.
              </p>
            </li>
            <li>
              <p>
                I use{' '}
                <CustomLink href="https://plausible.io">Plausible</CustomLink>{' '}
                for Analytics. It&apos;s a simple, open source, lightweight and
        ...
        <ul>
          <li>
            <p>
              ...
              and never looked back. It offers so much customization, like
              storing the height of your standing position. So it&apos;s an
          ...
          <li>
            <p>
              I have two keybords that I use in a kind of rotation. The first
              one is the Apple Magic Keyboard without the numeric keypad. The
              second one is the Keychron K2.
            </p>
          </li>
          <li>
