...
const Footer = () => {
  ...
  return (
    <ui.Footer>
        ...
        <ul>
          <ui.ListItem>
            <a href="mailto:hello@marcokuehbauch.com">
              <ui.Svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 512 512">
                <title>hello@marcokuehbauch.com</title>
                <path fill="#fff" d="M420.02455 354.77865l-99.60115-98.53796 99.59726-98.53797v197.07593zm-311.06513 18.71317l99.78039-98.44549 4.26255 4.03225c23.56094 22.20628 61.0005 22.20628 83.55619 0l4.29373-4.21326 100.24015 98.6265H108.95942zm-17.89961-215.7891l99.44921 98.53797-99.62844 98.53796.17923-197.07593zm309.84949-18.80563L278.3862 259.91094c-12.44868 12.39715-34.73163 12.12371-47.54657-.48141L109.14255 138.89709H400.9093zM64 112v288h384V112H64z"/>
              </ui.Svg>
            </a>
          </ui.ListItem>
          <ui.ListItem>
            <a href="https://www.linkedin.com/in/marco-k%C3%BChbauch/" target="_blank" rel="noopener noreferrer">
            ...
            <a href="http://codepen.io/Mkuehb/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 500 500">
                ...
                <g>
                  ...
                  <path fill="#fff" d="M394.462,203.737c-0.026-0.183-0.072-0.358-0.103-0.542c-0.062-0.351-0.126-0.702-0.218-1.045
          ...
          <ui.ListItem>
            <a href="https://github.com/mkuehb" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 1024 1024">
                <title>Marco Kuehbauch on GitHub</title>
                <path fill="#fff" d="M512,0C229.25,0,0,229.25,0,512c0,226.25,146.688,418.125,350.156,485.812c25.594,4.688,34.938-11.125,34.938-24.625
      ...
      </ui.Heart>. <a href="/impressum">Impressum.</a></p>
    </ui.Footer>
  )
};
