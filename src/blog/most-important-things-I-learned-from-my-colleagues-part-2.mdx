...
This blog post is part 2 of a series. You can check out part 1 over here: [Part 1](/blog/most-important-things-I-learned-from-my-colleagues-part-1/)
...
We all know that feeling. You're sitting in a meeting with a bunch of people. You're talking about a complex topic. Someone explains the details of it. They ask, if everyone understands the topic. Everyone nods.

But you don't. You have a lot of questions. But you really hesitate to ask. Everyone clearly signalled, that they are all clear. So why bother everyone because you're still in the unclear?

And, if it's a "stupid" question, you don't want to embarass yourself. What if the problem is just that you didn't listen well enough?

Forget about all this. **It doesn't matter**. If you still have questions and don't understand something clear enough, ask! Ask again. And again.

Because if you're the one who is implementing this feature later and you don't understand it, that's the real problem. Than you really wasted a lot of time.
...
Communication is hard. In my opinion, for being a good developer you're communication should be a **number one priority**. Communication is one of the topics where a lot of things can go wrong if it's bad.
...
Deep in your heart you want to be on the same page as this person.
...
If you break it down to one thing, that we're doing in web development, it's **we're solving problems of people**. We have users who's lifes we want to make **easier and better**.
...
Imagine you have three team members who are proficient in TypeScript,. This means you can develop this certain feature with a high quality standard and pretty fast. Which means the user will benefit a lot from it.
