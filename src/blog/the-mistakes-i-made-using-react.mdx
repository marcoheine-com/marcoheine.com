...
component. As the React docs put it: React is all about one-way data flow down
the component hierarchy. [https://reactjs.org/docs/thinking-in-react.html] Makes
