---
title: Getting started with golang - a beginners introduction to programming in go
date: 2021-02-22
path: /getting-started-with-golang-a-beginners-introduction-to-programming-in-go
---
...
You can send me an [email](mailto:marcokuehbauch@gmail.com) or message me on [Twitter](https://twitter.com/Mkuehb).
