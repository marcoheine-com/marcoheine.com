...
description:
  Today I learned, that there is a new HTML Sanitizer API which makes it easy to
  sanitize HTML to prevent cross-site-scripting.
date: 2022-07-21
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTML_Sanitizer_API" target="_blank">HTML
Sanitizer API &#8599;</a>.
...
term of XSS, also known as
<a href="https://developer.mozilla.org/en-US/docs/Glossary/Cross-site_scripting" target="_blank">cross-site
scripting &#8599;</a> is one of the most common security issues on the web.
